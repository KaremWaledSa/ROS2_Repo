...
#include "custom_pkg/msg/detail/age__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_pkg::msg::Age;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_pkg::msg::Age *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_pkg::msg::Age *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_custom_pkg
const rosidl_message_type_support_t *
get_message_type_support_handle<custom_pkg::msg::Age>()
{
  return &custom_pkg::msg::typesupport_fastrtps_cpp::_Age__handle;
}

...
static const _Age_type_support_symbol_names_t _Age_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_pkg, msg, Age)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_pkg, msg, Age)),
  }
};
...
{
  return &::custom_pkg::msg::rosidl_typesupport_cpp::Age_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_pkg, msg, Age)() {
  return get_message_type_support_handle<custom_pkg::msg::Age>();
}

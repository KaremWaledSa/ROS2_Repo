...
#ifndef CUSTOM_MSG__MSG__DETAIL__AGE__TRAITS_HPP_
#define CUSTOM_MSG__MSG__DETAIL__AGE__TRAITS_HPP_
...
inline std::string to_yaml(const custom_msg::msg::Age & msg)
{
  return custom_msg::msg::to_yaml(msg);
}

template<>
inline const char * data_type<custom_msg::msg::Age>()
{
  return "custom_msg::msg::Age";
}

template<>
inline const char * name<custom_msg::msg::Age>()
{
  return "custom_msg/msg/Age";
}

template<>
struct has_fixed_size<custom_msg::msg::Age>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<custom_msg::msg::Age>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<custom_msg::msg::Age>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // CUSTOM_MSG__MSG__DETAIL__AGE__TRAITS_HPP_

...
{
  new (message_memory) custom_msg::msg::Age(_init);
}

void Age_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msg::msg::Age *>(message_memory);
  typed_message->~Age();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Age_message_member_array[3] = {
  {
    ...
    offsetof(custom_msg::msg::Age, year),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msg::msg::Age, month),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msg::msg::Age, day),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::custom_msg::msg::rosidl_typesupport_introspection_cpp::Age_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msg, msg, Age)() {
  return &::custom_msg::msg::rosidl_typesupport_introspection_cpp::Age_message_type_support_handle;
}
